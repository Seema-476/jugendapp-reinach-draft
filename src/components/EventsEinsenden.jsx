        ...
        <div className='bg-sky-blue lg:py-[60px] py-11'>
            <div className='container'>
                ...
                <form onSubmit={handleSubmit}>
                    <div className='bg-white rounded-[30px] p-4 max-w-[763px] mx-auto md:mb-5 mb-3 border-light-blue border-[0.5px] border-dashed'>
                    ...
                    <div className='max-w-[763px] w-full flex max-sm:flex-col mx-auto sm:gap-5'>
                        <input
                            ...
                            className="font-bold text-sm leading-custom-xl text-gray md:mb-5 mb-3 w-full mx-auto flex py-[17.5px] px-4 rounded-[30px] placeholder:text-gray outline-none border-light-blue border-[0.5px]"
                        />
                        <input
                            type="text"
                            name="date"
                            ...
                            className="font-bold text-sm leading-custom-xl w-full text-gray md:mb-5 mb-3 mx-auto flex py-[17.5px] px-4 rounded-[30px] placeholder:text-gray outline-none border-light-blue border-[0.5px]"
                        />
                    </div>
                    <div className='max-w-[763px] w-full flex max-sm:flex-col mx-auto sm:gap-5'>
                        <input
                    ...
                    <textarea
                        ...
                        className="font-bold text-sm leading-custom-xl w-full text-gray md:mb-5 mb-3 mx-auto flex pt-[55.5px] px-4 rounded-[30px] max-w-[763px] placeholder:text-gray outline-none border-light-blue border-[0.5px] resize-none"></textarea>
